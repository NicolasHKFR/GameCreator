...
class AnimationScreen(QWidget):
    def __init__(self, main_window, project):
        ...
        right_layout.addWidget(QLabel("Animation Type:"))
        right_layout.addWidget(self.anim_type)

        self.fps = QSpinBox()
        self.fps.setRange(4, 24)
        self.fps.setValue(8)
        right_layout.addWidget(QLabel("FPS:"))
        right_layout.addWidget(self.fps)

        self.frame_count = QSpinBox()
        self.frame_count.setRange(4, 64)
        self.frame_count.setValue(16)
        right_layout.addWidget(QLabel("Frame Count:"))
        right_layout.addWidget(self.frame_count)
